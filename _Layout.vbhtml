...
<head>
    ...
    <title>@ViewBag.Title - Personal Finance Tracking</title>
...
<body>
    <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-dark bg-dark">
        <div class="container">
            @Html.ActionLink("Finance Tracking", "Index", "Home", New With {.area = ""}, New With {.class = "navbar-brand"})
    ...
    <div class="container body-content">
        ...
        <hr />
        <footer>
            <p>&copy; @DateTime.Now.Year - Personal Finance Tracking</p>
        </footer>
    </div>
